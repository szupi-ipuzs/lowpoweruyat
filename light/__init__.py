...
LPUyatColorType = lpuyat_ns.enum("LPUyatColorType")

COLOR_TYPES = {
    "RGB": LPUyatColorType.RGB,
    "HSV": LPUyatColorType.HSV,
    "RGBHSV": LPUyatColorType.RGBHSV,
}

LPUyatLight = lpuyat_ns.class_("LPUyatLight", light.LightOutput, cg.Component)
...
CONFIG_SCHEMA = cv.All(
    light.BRIGHTNESS_ONLY_LIGHT_SCHEMA.extend(
        {
            cv.GenerateID(CONF_OUTPUT_ID): cv.declare_id(LPUyatLight),
            ...
            # The LPUyat MCU handles transitions and gamma correction on its own.
