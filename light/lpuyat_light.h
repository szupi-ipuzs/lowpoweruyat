...
enum LPUyatColorType {
  RGB,
  HSV,
  RGBHSV,
};

class LPUyatLight : public Component, public light::LightOutput {
 public:
  void setup() override;
  ...
  void set_color_type(LPUyatColorType color_type) { this->color_type_ = color_type; }
 ...
 protected:
  ...
  optional<LPUyatColorType> color_type_{};
