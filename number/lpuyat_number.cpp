...
#include "lpuyat_number.h"

namespace esphome {
namespace lpuyat {

static const char *const TAG = "lpuyat.number";

void LPUyatNumber::setup() {
  ...
  this->parent_->register_listener(this->number_id_, [this](const LPUyatDatapoint &datapoint) {
    if (datapoint.type == LPUyatDatapointType::INTEGER) {
...
void LPUyatNumber::dump_config() {
  LOG_NUMBER("", "LPUyat Number", this);
