...
#include "lpuyat_select.h"

namespace esphome {
namespace lpuyat {

static const char *const TAG = "lpuyat.select";

void LPUyatSelect::setup() {
  this->parent_->register_listener(this->select_id_, [this](const LPUyatDatapoint &datapoint) {
...
void LPUyatSelect::control(const std::string &value) {
  if (this->optimistic_)
...
void LPUyatSelect::dump_config() {
  LOG_SELECT("", "LPUyat Select", this);
